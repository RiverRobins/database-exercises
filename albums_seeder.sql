...
VALUES ('Michael Jackson', 'Thriller', 1982, 47.3,'Pop, Rock, R&B'),
       ...
       ('Eagles', 'Their Greatest Hits', 1977, 41.2, 'Country Rock, Soft Rock, Folk Rock'),
       ...
       ('Madonna', 'The Immaculate Collection', 1990, 19.4, 'Pop, Disco'),
       ('The Beatles', 'Abbey Road', 1969, 14.4, 'Pop, Dance'),
       ('Bruce Stringsteen', 'Born in the U.S.A.', 1984, 19.6, 'Heartland Rock'),
